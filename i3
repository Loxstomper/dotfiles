...
bindsym $mod+d exec rofi -show run -font "System San Fransisco Display 25" -lines 3 -width 100 -padding 800 -opacity "80"
...
# finds out, if available)
 bar{
     position top
     status_command i3blocks -c /home/lox/.config/i3/i3blocks.conf
     colors {
         background #002b36
         statusline #839496
         separator  #586e75
...
# MY STUFF
bindsym $mod+shift+x exec /bin/mylock  
exec_always feh --bg-scale /home/lox/Firefox_wallpaper.png
gaps inner 10 
gaps outer 10
...
# Forcing applications to specific work spaces
...
bindsym Print exec "scrot ~/Pictures/screenshots/$(date).png" 
